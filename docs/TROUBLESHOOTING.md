...
1. **GitHub Issues**: [Create an issue](https://github.com/LoonieLoonz/hyprupld/issues)
2. **GitHub Discussions**: [Ask in discussions](https://github.com/LoonieLoonz/hyprupld/discussions)
